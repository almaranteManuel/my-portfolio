    ...
    <section class="section bg-light-secondary dark:bg-dark-secondary">
        <div class="container mx-auto">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="subtitle">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi a praesentium ea.
                </p>
            </div>
            <div class="grid lg:grid-cols-4 gap-8">
                <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro ea similique reprehenderit iusto tenetur.
                    </p>
                </div>
                <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
                    <div class="text-accent rounded-sm w-12 h-12 flex justify-center items-center mb-24 text-[28px]">
                ...
                <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
                    ...
                    <h4 class="text-xl font-medium mb-2">Back End</h4>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro ea similique reprehenderit iusto tenetur.
                    </p>
                </div>
                <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
                    ...
                    <h4 class="text-xl font-medium mb-2">Front End</h4>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro ea similique reprehenderit iusto tenetur.
                    </p>
                </div>
