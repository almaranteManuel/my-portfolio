...
<template>
    <section class="section bg-light-primary dark:bg-dark-secondary" id="contact">
        <div class="container mx-auto" v-motion :initial="{opacity: 0, y:100}" :visible="{opacity: 1, y:0}">
            ...
            <div class="flex flex-col lg:flex-row lg:gap-x-8">
                <div class="flex flex-1 flex-col items-start space-y-8 mb-12 lg:mb-0 lb:pt-2">
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-accent font-normal">Email me at almarante.manu@gmail.com</p>
                        </div>
                    </div>
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        <div
                        ...
                        <div>
                            ...
                            <p class="mb-1 text-paragraph">Parana, Entre Rios. Argentina.</p>
                            <p class="text-accent font-normal">Serving worldwide.</p>
                        </div>
                    </div>
                </div>
                <form @submit.prevent="submit" action="" class="space-y-8 w-full max-w-md">
                    ...
                    <textarea v-model="form.body" class="textarea" placeholder="Your Message" spellcheck="false" id="" cols="30" rows="10"></textarea>
