...
<nav class="bg-light-primary border-gray-200 dark:bg-dark-primary">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="http://127.0.0.1:8000/" class="flex items-center">
        <img src="http://127.0.0.1:8000/img/logo.jpeg" class="h-8 mr-3" alt="Flowbite Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Almarante Manuel</span>
    </a>
